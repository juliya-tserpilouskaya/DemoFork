...
{
    public class Service_Question_ChoosingAnswerFromList : IService_Question
    {
        protected readonly DbContext_Test _context;

        private bool _isDisposed = false;

        protected Service_Question_ChoosingAnswerFromList(DbContext_Test context)
        {
            _context = context;
        }
        ...
        ~Service_Question_ChoosingAnswerFromList()
        {
            this.Dispose(false);
        }
    }
