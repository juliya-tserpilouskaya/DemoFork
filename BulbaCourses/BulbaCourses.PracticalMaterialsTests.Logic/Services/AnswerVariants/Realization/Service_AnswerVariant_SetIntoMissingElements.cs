...
{
    public class Service_AnswerVariant_SetIntoMissingElements : IService_AnswerVariant
    {
        protected readonly DbContext_Test _context;

        private bool _isDisposed = false;

        protected Service_AnswerVariant_SetIntoMissingElements(DbContext_Test context)
        {
            _context = context;
        }
        ...
        ~Service_AnswerVariant_SetIntoMissingElements()
        {
            this.Dispose(false);
        }
    }
